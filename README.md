...
This code turns a spreadsheet (in csv form) into fill-in-the-blank anki flashcards for learning species latin names, common names, family, and other information.
...
I plan to make a version of this code in R, which will be the version that I continue to update because I actually use R consistently and understand its syntax better. In my experience, R is also used by many students in biology so people who would benefit from this project would be more likely to know how to run R code. 

## For Absolute Beginners
There will eventually be a guide here, and a link to a very user-friendly version of the R code, once it is made. One of the issues that I ran into while making this project was that I knew what my code needed to do, and I knew that there were likely other poeple who had done similar things, but even if I had found a project for this exact purpose, I wouldn't have known how to run their code. 

Eventually, I will add a guide here for people in this same situation. 
...
## For those who understand R (at least a little)
I intend to translate the Python code into R. This will be the main version of the code, with the greatest functionality. This version will be for poeple who understand how R works (at least a little bit), as you will have to edit the settings for different variables inside the code itself, instead of being prompted for inputs like in the Python code. 

This requires more skill than the beginner R code, but it will also allow easy editing and adaptation of the code for different use cases.
